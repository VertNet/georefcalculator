...
//public class GC extends Applet implements ActionListener, ItemListener, FocusListener, KeyListener{ 
	...
	var g_appletWidth = 620;
	var g_versionNumber = "20151031";
	...
	var g_canonicalheadings = {};
	var g_canonicalcoordsystems = {};
	var g_canonicalloctypes = {};
	var g_canonicalcalctypes = {};
	var g_canonicalddprec = {};
	var g_canonicaldmsprec = {};
	var g_canonicalddmprec = {};
	var g_canonicalsources = {};
	var g_languagelist = {};
	
	//Locale currentLocale = Locale.getDefault();
	var g_currentLocale = getDefaultLocal();
	//NumberFormat numberFormatter = NumberFormat.getNumberInstance(currentLocale); 
	//BUGBUG this wont work exactly
	var g_numberFormatter = getNumberInstance(currentLocale); 
	var g_language = null;
*/
//moved to gc.ui.js
